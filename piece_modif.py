    ...
    def deplacement_autorise(self, case_souhaitee):
        ...
        if self.name == "pawn":
            ...
            def avancer_pion(
                ...
                if case_souhaitee == self.position + Position(
                    0, 1
            ...
            def avancer_2_pion(case_souhaitee):
                if (
                    case_souhaitee == self.position + Position(0, 2)
                    and self.case_autorisee(case_souhaitee)
        ...
        if self.name == "knight":
            ...
            return (case_souhaitee in cases_possibles) and self.case_autorisee(
                case_souhaitee
            )
        ...
        if self.name == "queen":
            ...
            for i in range(1, BOARD_SIZE):
                ...
                if case_souhaitee in rows_and_diagonals and self.case_autorisee(
                    case_souhaitee
                ):
                    direction = vect_unit(case_souhaitee, self.position)
                    boolean = True
